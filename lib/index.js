...
exports.Timeline = exports.findStartEndTime = exports.nearestMinutesUp = exports.nearestMinutesDown = exports.ZOOMLEVELS = exports.ItemProp = undefined;
...
var ItemProp = exports.ItemProp = _propTypes2.default.shape({
  /**
   ...
   */
  canDrag: _propTypes2.default.boolean,
  /**
   * Set to false to dissable time block resizing
   */
  canResize: _propTypes2.default.canResize
});

/**
 * Supported zoom levels
 */
var ZOOMLEVELS = exports.ZOOMLEVELS = [60, 30, 15, 10, 5, 1];
 ...
 * @returns {moment}
 */
var nearestMinutesDown = exports.nearestMinutesDown = function nearestMinutesDown(m, interval) {
 ...
 * @returns {moment}
 */
var nearestMinutesUp = exports.nearestMinutesUp = function nearestMinutesUp(m, interval) {
 ...
 */
var findStartEndTime = exports.findStartEndTime = function findStartEndTime(startTime, endTime, items, roundTo) {
  var result = {
    startTime: startTime,
    endTime: endTime
  };
  ...
  items.forEach(function (item) {
    ...
    var timeLength = _moment2.default.duration(item.end.diff(item.start, "minutes"), "minutes", true).asMinutes();
    var end = item.end;
...
TimeLabel.propTypes = process.env.NODE_ENV !== "production" ? {
   ...
   */
  time: _propTypes2.default.instanceOf(_moment2.default).isRequired,
  /**
...
var ResizeHandle = function (_PureComponent) {
  ...
  function ResizeHandle(props) {
    ...
    _this.reference = _react2.default.createRef();
...
var TimeBlock = (_temp = _class = function (_PureComponent2) {
  ...
  function TimeBlock(props) {
    ...
    _this2.reference = _react2.default.createRef();
  ...
  TimeBlock.prototype.render = function render() {
    ...
    return _react2.default.createElement(
      ...
      canResize && _react2.default.createElement(ResizeHandle, { className: 'top', onMove: onTopHandleMove, onApplyResize: onTopHandleApply }),
      _react2.default.createElement(
        'div',
        { className: 'content' },
        itemContentRenderer(item)
      ),
      canResize && _react2.default.createElement(ResizeHandle, { className: 'bottom', onMove: onBottomHandleMove, onApplyResize: onBottomHandleApply })
    );
  };
...
TimeBlock.propTypes = process.env.NODE_ENV !== "production" ? {
   ...
   */
  dataId: _propTypes2.default.oneOfType([_propTypes2.default.string, _propTypes2.default.number]),
  /**
   * An item content renderer callback to use when rendering custom content.
   */
  itemContentRenderer: _propTypes2.default.func.isRequired,
  /**
   ...
   */
  leftMargin: _propTypes2.default.number
} : {};
var Timeline = exports.Timeline = (_temp2 = _class2 = function (_PureComponent3) {
  ...
  function Timeline(props) {
    ...
    _this5.reference = _react2.default.createRef();
  ...
  Timeline.prototype.onMouseUp = function onMouseUp(e) {
    ...
    if (this.moveBlock && this.moveBlockNewY) {
      ...
      var _props3 = this.props,
          ...
          startTime = _props3$startTime === undefined ? (0, _moment2.default)().startOf("day") : _props3$startTime,
          _props3$endTime = _props3.endTime,
          endTime = _props3$endTime === undefined ? (0, _moment2.default)().endOf("day") : _props3$endTime;
      ...
      var blockLengthinMinutes = _moment2.default.duration(origItem.end.diff(origItem.start, "minutes"), "minutes", true).asMinutes();
  ...
  Timeline.prototype.render = function render() {
    ...
    var _props7 = this.props,
        ...
        startTime = _props7$startTime === undefined ? (0, _moment2.default)().startOf("day") : _props7$startTime,
        _props7$endTime = _props7.endTime,
        endTime = _props7$endTime === undefined ? (0, _moment2.default)().endOf("day") : _props7$endTime;
    ...
    if (timeHeader || contentHeader) {
      idx++;
      slices.push(_react2.default.createElement(
        'div',
        {
          key: 'headers',
    ...
    var _loop = function _loop(t) {
      ...
      slices.push(_react2.default.createElement(
        ...
        _react2.default.createElement(TimeLabel, {
          time: t.clone(),
      ...
      if (foundItems.length > 0) {
        foundItems.forEach(function (item) {
          ...
          var startDiff = _moment2.default.duration(tmpStart.diff(t, "minutes"), "minutes", true).asMinutes();
          ...
          var blockLegth = _moment2.default.duration(tmpEnd.diff(tmpStart, "minutes") + correction, "minutes", true).asMinutes();
          ...
          blocks.push(_react2.default.createElement(TimeBlock, {
    ...
    for (var t = (0, _moment2.default)(startTime); t.isBefore(endTime); t.add(zoomMinutes, "minutes")) {
      _loop(t);
    }
...
Timeline.propTypes = process.env.NODE_ENV !== "production" ? {
   ...
   */
  zoom: _propTypes2.default.oneOf([0, 1, 2, 3, 4, 5]),
  /**
   ...
   */
  itemContentRenderer: _propTypes2.default.func.isRequired,
  onTimeBlockChange: _propTypes2.default.func.isRequired
} : {};
