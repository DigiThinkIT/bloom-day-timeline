...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["BloomDayTimeline"] = factory(require("react"));
	else
		root["BloomDayTimeline"] = factory(root["React"]);
...
var momentValidationWrapper = __webpack_require__(136);
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ItemProp", function() { return ItemProp; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ZOOMLEVELS", function() { return ZOOMLEVELS; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "nearestMinutesDown", function() { return nearestMinutesDown; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "nearestMinutesUp", function() { return nearestMinutesUp; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "findStartEndTime", function() { return findStartEndTime; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Timeline", function() { return Timeline; });
/* harmony import */ var _styles_less__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(129);
...
/* harmony import */ var moment__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(0);
/* harmony import */ var moment__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(moment__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var element_closest__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(133);
/* harmony import */ var element_closest__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(element_closest__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var prop_types__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(1);
/* harmony import */ var prop_types__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(prop_types__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var react_moment_proptypes__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(3);
/* harmony import */ var react_moment_proptypes__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(react_moment_proptypes__WEBPACK_IMPORTED_MODULE_5__);
...
var ItemProp = prop_types__WEBPACK_IMPORTED_MODULE_4___default.a.shape({
  /**
   * An id to track this item's state
   */
  id: prop_types__WEBPACK_IMPORTED_MODULE_4___default.a.oneOfType([prop_types__WEBPACK_IMPORTED_MODULE_4___default.a.string, prop_types__WEBPACK_IMPORTED_MODULE_4___default.a.number]).isRequired,
  /**
   * The start measurement of the item. Measured with momentjs.
   */
  start: react_moment_proptypes__WEBPACK_IMPORTED_MODULE_5___default.a.momentObj,
  /**
   * The end measure of the item. Measured with momentjs.
   */
  end: react_moment_proptypes__WEBPACK_IMPORTED_MODULE_5___default.a.momentObj,
  /**
   * Set to false to dissable time block dragging
   */
  canDrag: prop_types__WEBPACK_IMPORTED_MODULE_4___default.a.boolean,
  /**
   * Set to false to dissable time block resizing
   */
  canResize: prop_types__WEBPACK_IMPORTED_MODULE_4___default.a.canResize
});

/**
 * Supported zoom levels
 */
var ZOOMLEVELS = [60, 30, 15, 10, 5, 1];
 ...
 * @returns {moment}
 */
var nearestMinutesDown = function nearestMinutesDown(m, interval) {
 ...
 * @returns {moment}
 */
var nearestMinutesUp = function nearestMinutesUp(m, interval) {
 ...
 */
var findStartEndTime = function findStartEndTime(startTime, endTime, items, roundTo) {
  var result = {
    startTime: startTime,
    endTime: endTime
  };
  ...
  items.forEach(function (item) {
    ...
    var timeLength = moment__WEBPACK_IMPORTED_MODULE_2___default.a.duration(item.end.diff(item.start, "minutes"), "minutes", true).asMinutes();
    var end = item.end;
...
TimeLabel.propTypes = {
   ...
   */
  time: prop_types__WEBPACK_IMPORTED_MODULE_4___default.a.instanceOf(moment__WEBPACK_IMPORTED_MODULE_2___default.a).isRequired,
  /**
   * The time formatting used to render a label slice.
   */
  format: prop_types__WEBPACK_IMPORTED_MODULE_4___default.a.string
};
 ...
 */
var ResizeHandle = (_temp = _class = function (_PureComponent) {
  ...
  function ResizeHandle(props) {
    ...
    _this.reference = react__WEBPACK_IMPORTED_MODULE_1___default.a.createRef();
...
var TimeBlock = (_temp2 = _class2 = function (_PureComponent2) {
  ...
  function TimeBlock(props) {
    ...
    _this2.reference = react__WEBPACK_IMPORTED_MODULE_1___default.a.createRef();
  ...
  TimeBlock.prototype.render = function render() {
    ...
    return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(
      ...
      canResize && react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(ResizeHandle, { className: 'top', onMove: onTopHandleMove, onApplyResize: onTopHandleApply }),
      react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(
        'div',
        { className: 'content' },
        itemContentRenderer(item)
      ),
      canResize && react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(ResizeHandle, { className: 'bottom', onMove: onBottomHandleMove, onApplyResize: onBottomHandleApply })
    );
  };

  return TimeBlock;
}(react__WEBPACK_IMPORTED_MODULE_1__["PureComponent"]), _class2.propTypes = {
  /**
   ...
   */
  dataId: prop_types__WEBPACK_IMPORTED_MODULE_4___default.a.oneOfType([prop_types__WEBPACK_IMPORTED_MODULE_4___default.a.string, prop_types__WEBPACK_IMPORTED_MODULE_4___default.a.number]),
  /**
   * An item content renderer callback to use when rendering custom content.
   */
  itemContentRenderer: prop_types__WEBPACK_IMPORTED_MODULE_4___default.a.func.isRequired,
  /**
   ...
   */
  rightMargin: prop_types__WEBPACK_IMPORTED_MODULE_4___default.a.number,
  /**
   * The left margin measured in pixels. Used to display stacked time offsets.
   */
  leftMargin: prop_types__WEBPACK_IMPORTED_MODULE_4___default.a.number
...
var Timeline = (_temp3 = _class3 = function (_PureComponent3) {
  ...
  function Timeline(props) {
    ...
    _this5.reference = react__WEBPACK_IMPORTED_MODULE_1___default.a.createRef();
  ...
  Timeline.prototype.onMouseUp = function onMouseUp(e) {
    ...
    if (this.moveBlock && this.moveBlockNewY) {
      ...
      var _props3 = this.props,
          ...
          startTime = _props3$startTime === undefined ? moment__WEBPACK_IMPORTED_MODULE_2___default()().startOf("day") : _props3$startTime,
          _props3$endTime = _props3.endTime,
          endTime = _props3$endTime === undefined ? moment__WEBPACK_IMPORTED_MODULE_2___default()().endOf("day") : _props3$endTime;
      ...
      var blockLengthinMinutes = moment__WEBPACK_IMPORTED_MODULE_2___default.a.duration(origItem.end.diff(origItem.start, "minutes"), "minutes", true).asMinutes();
  ...
  Timeline.prototype.render = function render() {
    ...
    var _props7 = this.props,
        ...
        startTime = _props7$startTime === undefined ? moment__WEBPACK_IMPORTED_MODULE_2___default()().startOf("day") : _props7$startTime,
        _props7$endTime = _props7.endTime,
        endTime = _props7$endTime === undefined ? moment__WEBPACK_IMPORTED_MODULE_2___default()().endOf("day") : _props7$endTime;
    ...
    if (timeHeader || contentHeader) {
      idx++;
      slices.push(react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(
        'div',
        {
          key: 'headers',
    ...
    var _loop = function _loop(t) {
      ...
      slices.push(react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(
        ...
        react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(TimeLabel, {
          time: t.clone(),
      ...
      if (foundItems.length > 0) {
        foundItems.forEach(function (item) {
          ...
          var startDiff = moment__WEBPACK_IMPORTED_MODULE_2___default.a.duration(tmpStart.diff(t, "minutes"), "minutes", true).asMinutes();
          ...
          var blockLegth = moment__WEBPACK_IMPORTED_MODULE_2___default.a.duration(tmpEnd.diff(tmpStart, "minutes") + correction, "minutes", true).asMinutes();
          ...
          blocks.push(react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(TimeBlock, {
    ...
    for (var t = moment__WEBPACK_IMPORTED_MODULE_2___default()(startTime); t.isBefore(endTime); t.add(zoomMinutes, "minutes")) {
      _loop(t);
    }
  ...
  return Timeline;
}(react__WEBPACK_IMPORTED_MODULE_1__["PureComponent"]), _class3.propTypes = {
  /**
   ...
   */
  zoom: prop_types__WEBPACK_IMPORTED_MODULE_4___default.a.oneOf([0, 1, 2, 3, 4, 5]),
  /**
   ...
   */
  timeHeader: prop_types__WEBPACK_IMPORTED_MODULE_4___default.a.node,
  /**
   * Header string or component to render over timeline content column
   * Note that this row is of fixed size atm and your component shouldn't stretch or shrink it.
   * If you need more than the current height, render the columns outside of the component.
   */
  contentHeader: prop_types__WEBPACK_IMPORTED_MODULE_4___default.a.node,
  /**
   * Array of time slices. The object must contain an id and start and end time measurements using
   * the momentsjs library.
   */
  items: prop_types__WEBPACK_IMPORTED_MODULE_4___default.a.arrayOf(ItemProp).isRequired,
  /**
   ...
   */
  itemContentRenderer: prop_types__WEBPACK_IMPORTED_MODULE_4___default.a.func.isRequired,
  onTimeBlockChange: prop_types__WEBPACK_IMPORTED_MODULE_4___default.a.func.isRequired
